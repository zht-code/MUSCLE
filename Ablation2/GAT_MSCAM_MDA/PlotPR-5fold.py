...
RAPName = 'Ablation2/GAT_MSCAM_MDA/att_1_int.csv'
RAPNameProb = 'Ablation2/GAT_MSCAM_MDA/att_1_pro.csv'
...
#tprs[-1][0] = 0.0
# MyEnlarge(0.7, 0.7, 0.25, 0.25, 0, 0.01, 2, mean_fpr, tprs[0], 1.5, colorlist[0])
...
while counter < len(mean_fpr):
    ...
    counter = counter + 1
storFile(FprAndTpr, 'Ablation2/GAT_MSCAM_MDA/GAT_MSCAM_MDA_PR.csv')#这个文件是为了和别的。消融实验的模型的结果比较，用来绘制比较的PR图
