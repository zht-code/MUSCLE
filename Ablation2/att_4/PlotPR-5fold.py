...
RAPName = 'Ablation2/att_4/att_1_int.csv'
RAPNameProb = 'Ablation2/att_4/att_1_pro.csv'
...
while counter < len(mean_fpr):
    ...
    counter = counter + 1
storFile(FprAndTpr, 'Ablation2/att_4/att_4_PR.csv')#这个文件是为了和别的。消融实验的模型的结果比较，用来绘制比较的PR图
