...
if __name__ == '__main__':
    ...
    for train_index, test_index in kfold.split(dataset['all_sample'][:,:2]):
        ...
        # StorFile(test_sample_index.tolist(), 'data/data/test_sample_index_5.csv')
        # StorFile([str(x) for x in test_label], 'data/data/test_label_5.csv')
        ...
        for i in range(args.epochs):
            ...
            if test_auc > max_test_auc:
                t.save(model.state_dict(), "./save_model/5_fold/5fold_train_model.pth")
